            ...
            child: SensibleFutureBuilder(
                ...
                builder: (context, snapshot) {
                  int index = snapshot.data!
                      .indexWhere((element) => element == SharedPreferencesInterface.season);
                  if (index < 0) index = snapshot.data!.length - 1;
                  if (snapshot.data![index] != SharedPreferencesInterface.season) {
                    WidgetsBinding.instance.addPostFrameCallback(
                        (_) => SharedPreferencesInterface.season = snapshot.data![index]);
                  }
                  return Padding(
                      ...
                      child: CarouselSlider(
                          ...
                          options: CarouselOptions(
                              ...
                              onPageChanged: (i, _) =>
                                  SharedPreferencesInterface.season = snapshot.data![i])));
                },
                ...
                child: ListenableBuilder(
                    ...
                    builder: (context, child) => SensibleFutureBuilder(
                        future: BlueAlliance.stock.get(TBAInfo(
                            season: SharedPreferencesInterface
                                .season)), // TODO implement pull-to-refresh for the tba event data
                        builder: (context, snapshot) {
                          ...
                          String maybeEvent = SharedPreferencesInterface.event ??
                                        ...
                                        items: entries
                                            ...
                                            .map((enumeratedEntry) => ListTile(
                                                ...
                                                onTap: () => _eventCarouselController
                                                    ...
                                                    .then((_) => BlueAlliance.batchFetch(
