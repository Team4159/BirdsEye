...
mixin _$PitScoutRoute on GoRouteData {
  static PitScoutRoute _fromState(GoRouterState state) => PitScoutRoute(
        int.parse(state.uri.queryParameters['season']!),
...
mixin _$MatchScoutRoute on GoRouteData {
  static MatchScoutRoute _fromState(GoRouterState state) => MatchScoutRoute(
        matchCode: state.uri.queryParameters['match-code']!,
      );
